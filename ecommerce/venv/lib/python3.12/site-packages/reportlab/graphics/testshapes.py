...
__version__ = ''' $Id $ '''
__doc__='''Execute this script to see some tests drawings.

This contains a number of routines to generate tests drawings
...
def getDrawing09():
    ...
    Some renderers will have a separate mechanism for font drawing.  This tests
...
class ShapesTestCase(unittest.TestCase):
    ...
    # wrapped in a dedicated tests method like this one, it
...
def makeSuite():
    "Make a tests suite for unit testing."
