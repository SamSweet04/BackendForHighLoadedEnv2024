...
def fullTest(fileName="test_full.pdf"):
    """Creates large-ish tests document with a variety of parameters"""
    ...
    story.append(Paragraph("""
        This is the tests suite and docoumentation for the ReportLab open source barcode API.
        """, styleN))
    ...
    story.append(Paragraph("""
        ...
        is the output of the current tests suite.  It contains codes you can scan (if you use a nice sharp
    ...
    story.append(Paragraph("""
        ...
        inspection.  This will be expanded to include several tests cases per code, and to add
