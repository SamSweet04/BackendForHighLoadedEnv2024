...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "celery(**overrides): override celery configuration for a tests case"
    )
...
def celery_session_worker(
    ...
    # type: (...) -> WorkController
    """Session Fixture: Start worker that lives throughout tests suite."""
...
def celery_config():
    ...
    """Redefine this fixture to configure the tests Celery app.
...
def celery_parameters():
    # type: () -> Mapping[str, Any]
    """Redefine this fixture to change the init parameters of tests Celery app.
...
def celery_class_tasks():
    """Redefine this fixture to register tasks with the tests Celery app."""
    return []
...
def celery_worker(request,
    ...
    """Fixture: Start worker in a thread, stop it when the tests returns."""
    from .testing import worker
