...
def _select(readers=None, writers=None, err=None, timeout=0,
    ...
    Arguments:
        readers (Set[Fd]): Set of reader fds to tests if readable.
        writers (Set[Fd]): Set of writer fds to tests if writable.
        err (Set[Fd]): Set of fds to tests for error condition.
